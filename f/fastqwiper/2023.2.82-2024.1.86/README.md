# Comparing `tmp/fastqwiper-2023.2.82-py3-none-any.whl.zip` & `tmp/fastqwiper-2024.1.86-py3-none-any.whl.zip`
...
## Comparing `fastqwiper-2023.2.82.dist-info/LICENSE` & `fastqwiper-2024.1.86.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `fastqwiper-2023.2.82.dist-info/METADATA` & `fastqwiper-2024.1.86.dist-info/METADATA`
