# Comparing `tmp/balsamic-0.0.15.tar.gz` & `tmp/balsamic-0.0.16.tar.gz`
...
## Comparing `balsamic-0.0.15.tar` & `balsamic-0.0.16.tar`
...
### Comparing `balsamic-0.0.15/PKG-INFO` & `balsamic-0.0.16/PKG-INFO`
...
### Comparing `balsamic-0.0.15/README.md` & `balsamic-0.0.16/README.md`

 * *Files identical despite different names*

### Comparing `balsamic-0.0.15/balsamic.egg-info/PKG-INFO` & `balsamic-0.0.16/balsamic.egg-info/PKG-INFO`
...
### Comparing `balsamic-0.0.15/setup.py` & `balsamic-0.0.16/setup.py`
