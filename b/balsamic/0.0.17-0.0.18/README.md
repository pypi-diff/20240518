# Comparing `tmp/balsamic-0.0.17.tar.gz` & `tmp/balsamic-0.0.18.tar.gz`
...
## Comparing `balsamic-0.0.17.tar` & `balsamic-0.0.18.tar`
...
### Comparing `balsamic-0.0.17/PKG-INFO` & `balsamic-0.0.18/PKG-INFO`
...
### Comparing `balsamic-0.0.17/README.md` & `balsamic-0.0.18/README.md`

 * *Files identical despite different names*

### Comparing `balsamic-0.0.17/balsamic/__main__.py` & `balsamic-0.0.18/balsamic/__main__.py`

 * *Files identical despite different names*

### Comparing `balsamic-0.0.17/balsamic.egg-info/PKG-INFO` & `balsamic-0.0.18/balsamic.egg-info/PKG-INFO`
...
### Comparing `balsamic-0.0.17/setup.py` & `balsamic-0.0.18/setup.py`
