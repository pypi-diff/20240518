# Comparing `tmp/pyeasydbapi-0.1.7.tar.gz` & `tmp/pyeasydbapi-0.1.8.tar.gz`
...
## Comparing `pyeasydbapi-0.1.7.tar` & `pyeasydbapi-0.1.8.tar`
...
### Comparing `pyeasydbapi-0.1.7/PKG-INFO` & `pyeasydbapi-0.1.8/PKG-INFO`
...
### Comparing `pyeasydbapi-0.1.7/SimpleDB/main.py` & `pyeasydbapi-0.1.8/SimpleDB/main.py`
...
### Comparing `pyeasydbapi-0.1.7/pyEasyDbApi.egg-info/PKG-INFO` & `pyeasydbapi-0.1.8/pyEasyDbApi.egg-info/PKG-INFO`
...
### Comparing `pyeasydbapi-0.1.7/setup.py` & `pyeasydbapi-0.1.8/setup.py`
