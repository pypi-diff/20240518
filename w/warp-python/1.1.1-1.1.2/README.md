# Comparing `tmp/warp_python-1.1.1.tar.gz` & `tmp/warp_python-1.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "warp_python-1.1.1.tar", last modified: Sat May 18 14:14:35 2024, max compression
+gzip compressed data, was "warp_python-1.1.2.tar", last modified: Sat May 18 14:28:27 2024, max compression
```

## Comparing `warp_python-1.1.1.tar` & `warp_python-1.1.2.tar`

### file list

```diff
@@ -1,12 +1,20 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-18 14:14:35.908924 warp_python-1.1.1/
--rw-r--r--   0 runner    (1001) docker     (127)     1069 2024-05-18 14:14:31.000000 warp_python-1.1.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)      760 2024-05-18 14:14:35.904924 warp_python-1.1.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       72 2024-05-18 14:14:31.000000 warp_python-1.1.1/README.md
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-18 14:14:35.908924 warp_python-1.1.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      977 2024-05-18 14:14:31.000000 warp_python-1.1.1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-18 14:14:35.904924 warp_python-1.1.1/warp_python.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      760 2024-05-18 14:14:35.000000 warp_python-1.1.1/warp_python.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      200 2024-05-18 14:14:35.000000 warp_python-1.1.1/warp_python.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-18 14:14:35.000000 warp_python-1.1.1/warp_python.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       15 2024-05-18 14:14:35.000000 warp_python-1.1.1/warp_python.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-18 14:14:35.000000 warp_python-1.1.1/warp_python.egg-info/top_level.txt
...
### Comparing `warp_python-1.1.1/LICENSE` & `warp_python-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `warp_python-1.1.1/PKG-INFO` & `warp_python-1.1.2/PKG-INFO`
...
### Comparing `warp_python-1.1.1/setup.py` & `warp_python-1.1.2/setup.py`
...
### Comparing `warp_python-1.1.1/warp_python.egg-info/PKG-INFO` & `warp_python-1.1.2/warp_python.egg-info/PKG-INFO`
