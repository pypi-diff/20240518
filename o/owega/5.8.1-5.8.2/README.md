# Comparing `tmp/owega-5.8.1.tar.gz` & `tmp/owega-5.8.2.tar.gz`
...
### Comparing `owega-5.8.1/owega/OweHandlers/handle_commands.py` & `owega-5.8.2/owega/OweHandlers/handle_commands.py`
