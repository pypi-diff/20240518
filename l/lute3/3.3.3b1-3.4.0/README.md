# Comparing `tmp/lute3-3.3.3b1.tar.gz` & `tmp/lute3-3.4.0.tar.gz`
...
### Comparing `lute3-3.3.3b1/.github/ISSUE_TEMPLATE/add_language.md` & `lute3-3.4.0/.github/ISSUE_TEMPLATE/add_language.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.github/ISSUE_TEMPLATE/bug_report.md` & `lute3-3.4.0/.github/ISSUE_TEMPLATE/bug_report.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.github/ISSUE_TEMPLATE/documentation.md` & `lute3-3.4.0/.github/ISSUE_TEMPLATE/documentation.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.github/ISSUE_TEMPLATE/feature_request.md` & `lute3-3.4.0/.github/ISSUE_TEMPLATE/feature_request.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.github/workflows/ci.yml` & `lute3-3.4.0/.github/workflows/ci.yml`
...
### Comparing `lute3-3.3.3b1/.github/workflows/coverage.yml` & `lute3-3.4.0/.github/workflows/coverage.yml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.gitignore` & `lute3-3.4.0/.gitignore`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.pylintrc` & `lute3-3.4.0/.pylintrc`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/.pytest.ini` & `lute3-3.4.0/.pytest.ini`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/LICENSE.txt` & `lute3-3.4.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/README.md` & `lute3-3.4.0/README.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/README_PyPi.md` & `lute3-3.4.0/README_PyPi.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/devstart.py` & `lute3-3.4.0/devstart.py`
...
### Comparing `lute3-3.3.3b1/docker/Dockerfile` & `lute3-3.4.0/docker/Dockerfile`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/docker/build_all.sh` & `lute3-3.4.0/docker/build_all.sh`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/docker/check_mounts_and_start.sh` & `lute3-3.4.0/docker/check_mounts_and_start.sh`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/docker/docker_hub_overview.md` & `lute3-3.4.0/docker/docker_hub_overview.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/docker/try_build_multi.sh` & `lute3-3.4.0/docker/try_build_multi.sh`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/docs/CHANGELOG.md` & `lute3-3.4.0/docs/CHANGELOG.md`
...
### Comparing `lute3-3.3.3b1/lute/LICENSE.txt` & `lute3-3.4.0/lute/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/app_factory.py` & `lute3-3.4.0/lute/app_factory.py`
...
### Comparing `lute3-3.3.3b1/lute/backup/routes.py` & `lute3-3.4.0/lute/backup/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/backup/service.py` & `lute3-3.4.0/lute/backup/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/bing/routes.py` & `lute3-3.4.0/lute/bing/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/book/datatables.py` & `lute3-3.4.0/lute/book/datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/book/forms.py` & `lute3-3.4.0/lute/book/forms.py`
...
### Comparing `lute3-3.3.3b1/lute/book/model.py` & `lute3-3.4.0/lute/book/model.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/book/routes.py` & `lute3-3.4.0/lute/book/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/book/service.py` & `lute3-3.4.0/lute/book/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/book/stats.py` & `lute3-3.4.0/lute/book/stats.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/cli/commands.py` & `lute3-3.4.0/lute/cli/commands.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/cli/language_term_export.py` & `lute3-3.4.0/lute/cli/language_term_export.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/config/app_config.py` & `lute3-3.4.0/lute/config/app_config.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/config/config.yml.example` & `lute3-3.4.0/lute/config/config.yml.example`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/data_cleanup.py` & `lute3-3.4.0/lute/db/data_cleanup.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/demo.py` & `lute3-3.4.0/lute/db/demo.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/.github/workflows/ci.yml` & `lute3-3.4.0/lute/db/language_defs/.github/workflows/ci.yml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/README.md` & `lute3-3.4.0/lute/db/language_defs/README.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/afrikaans/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/afrikaans/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/afrikaans/die_diere_grawe_n_put.txt` & `lute3-3.4.0/lute/db/language_defs/afrikaans/die_diere_grawe_n_put.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/albanian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/albanian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/albanian/shqiponja_dhe_mbreti.txt` & `lute3-3.4.0/lute/db/language_defs/albanian/shqiponja_dhe_mbreti.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/amharic/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/amharic/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/amharic/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/amharic/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/arabic/ar_demo.txt` & `lute3-3.4.0/lute/db/language_defs/arabic/ar_demo.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/arabic/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/arabic/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/armenian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/armenian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/armenian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/armenian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/azerbaijani/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/azerbaijani/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/azerbaijani/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/azerbaijani/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/basque/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/basque/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/basque/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/basque/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/belarusian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/belarusian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/belarusian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/belarusian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/bengali/aharshi_the_bengal_tiger.txt` & `lute3-3.4.0/lute/db/language_defs/bengali/aharshi_the_bengal_tiger.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/bengali/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/bengali/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/breton/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/breton/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/breton/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/breton/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/bulgarian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/bulgarian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/bulgarian/yesterday_film_description.txt` & `lute3-3.4.0/lute/db/language_defs/bulgarian/yesterday_film_description.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/catalan/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/catalan/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/catalan/merlí_series_description.txt` & `lute3-3.4.0/lute/db/language_defs/catalan/merlí_series_description.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/classical_chinese/cc_demo.txt` & `lute3-3.4.0/lute/db/language_defs/classical_chinese/cc_demo.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/croatian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/croatian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/croatian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/croatian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/czech/czech.txt` & `lute3-3.4.0/lute/db/language_defs/czech/czech.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/danish/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/danish/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/danish/prinsessen_pa_arten.txt` & `lute3-3.4.0/lute/db/language_defs/danish/prinsessen_pa_arten.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/dutch/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/dutch/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/english/tutorial.txt` & `lute3-3.4.0/lute/db/language_defs/english/tutorial.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/english/tutorial_follow_up.txt` & `lute3-3.4.0/lute/db/language_defs/english/tutorial_follow_up.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/esperanto/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/esperanto/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/esperanto/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/esperanto/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/estonian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/estonian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/estonian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/estonian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/farsi/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/farsi/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/farsi/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/farsi/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/finnish/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/finnish/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/finnish/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/finnish/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/galician/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/galician/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/galician/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/galician/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/generic/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/generic/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/generic/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/generic/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/georgian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/georgian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/georgian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/georgian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/german/de_Stadtmusikanten.txt` & `lute3-3.4.0/lute/db/language_defs/german/de_Stadtmusikanten.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/german/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/german/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/gothic/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/gothic/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/gothic/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/gothic/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/greek/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/greek/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/greek/gr_demo.txt` & `lute3-3.4.0/lute/db/language_defs/greek/gr_demo.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/hebrew/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/hebrew/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/hebrew/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/hebrew/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/hindi/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/hindi/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/hindi/hi_wikipedia.txt` & `lute3-3.4.0/lute/db/language_defs/hindi/hi_wikipedia.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/hungarian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/hungarian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/icelandic/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/icelandic/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/icelandic/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/icelandic/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/indonesian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/indonesian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/indonesian/kura-kura_yang_sombong.txt` & `lute3-3.4.0/lute/db/language_defs/indonesian/kura-kura_yang_sombong.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/italian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/italian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/italian/le_avventure_di_pinocchio.txt` & `lute3-3.4.0/lute/db/language_defs/italian/le_avventure_di_pinocchio.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/japanese/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/japanese/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/latin/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/latin/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/latvian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/latvian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/latvian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/latvian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/lithuanian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/lithuanian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/lithuanian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/lithuanian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/norwegian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/norwegian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/norwegian/vildanden.txt` & `lute3-3.4.0/lute/db/language_defs/norwegian/vildanden.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/polish/adam_i_smoczy_skarb.txt` & `lute3-3.4.0/lute/db/language_defs/polish/adam_i_smoczy_skarb.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/polish/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/polish/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/portuguese/a_maldicao.txt` & `lute3-3.4.0/lute/db/language_defs/portuguese/a_maldicao.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/portuguese/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/portuguese/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/punjabi/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/punjabi/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/punjabi/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/punjabi/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/romanian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/romanian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/russian/ru_medved.txt` & `lute3-3.4.0/lute/db/language_defs/russian/ru_medved.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/sanskrit/sanskrit.txt` & `lute3-3.4.0/lute/db/language_defs/sanskrit/sanskrit.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/serbian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/serbian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/serbian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/serbian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/slovak/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/slovak/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/slovak/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/slovak/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/slovene/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/slovene/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/spanish/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/spanish/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/spanish/es_aladino.txt` & `lute3-3.4.0/lute/db/language_defs/spanish/es_aladino.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/swahili/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/swahili/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/swahili/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/swahili/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/swedish/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/swedish/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/swedish/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/swedish/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/tibetan/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/tibetan/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/tibetan/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/tibetan/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/turkish/tr_demo.txt` & `lute3-3.4.0/lute/db/language_defs/turkish/tr_demo.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/ukrainian/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/ukrainian/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/ukrainian/story_1.txt` & `lute3-3.4.0/lute/db/language_defs/ukrainian/story_1.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/verify_files.py` & `lute3-3.4.0/lute/db/language_defs/verify_files.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/vietnamese/definition.yaml` & `lute3-3.4.0/lute/db/language_defs/vietnamese/definition.yaml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/language_defs/vietnamese/lan_bien.txt` & `lute3-3.4.0/lute/db/language_defs/vietnamese/lan_bien.txt`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/management.py` & `lute3-3.4.0/lute/db/management.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/README.md` & `lute3-3.4.0/lute/db/schema/README.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/baseline.sql` & `lute3-3.4.0/lute/db/schema/baseline.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/empty.sql` & `lute3-3.4.0/lute/db/schema/empty.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230518_190000_remove_old_words_fields.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230518_190000_remove_old_words_fields.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230519_194627_add_TxDateRead.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230519_194627_add_TxDateRead.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_01_booktags.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_01_booktags.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_02_wordtags.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_02_wordtags.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_03_sentences.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_03_sentences.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_04_texttokens.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_04_texttokens.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_05_texts.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_05_texts.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_06_bookstats.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_06_bookstats.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_07_termimages.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_07_termimages.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_08_wordflashmessages.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_08_wordflashmessages.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_09_wordparents.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_09_wordparents.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_10_words.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_10_words.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230621_224416_fk_11_books.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230621_224416_fk_11_books.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230818_201200_add_BkWordCount.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230818_201200_add_BkWordCount.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20230827_052154_allow_multiple_word_parents.sql` & `lute3-3.4.0/lute/db/schema/migrations/20230827_052154_allow_multiple_word_parents.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20231018_211236_remove_excess_texts_fields.sql` & `lute3-3.4.0/lute/db/schema/migrations/20231018_211236_remove_excess_texts_fields.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20231101_203811_modify_settings_schema.sql` & `lute3-3.4.0/lute/db/schema/migrations/20231101_203811_modify_settings_schema.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20240125_drop_BkWordCount.sql` & `lute3-3.4.0/lute/db/schema/migrations/20240125_drop_BkWordCount.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20240125_drop_bookstats_wordcount.sql` & `lute3-3.4.0/lute/db/schema/migrations/20240125_drop_bookstats_wordcount.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20240207_01_create_languagedicts.sql` & `lute3-3.4.0/lute/db/schema/migrations/20240207_01_create_languagedicts.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations/20240207_02_drop_old_language_fields.sql` & `lute3-3.4.0/lute/db/schema/migrations/20240207_02_drop_old_language_fields.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations_repeatable/trig_wordparents.sql` & `lute3-3.4.0/lute/db/schema/migrations_repeatable/trig_wordparents.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/schema/migrations_repeatable/trig_words.sql` & `lute3-3.4.0/lute/db/schema/migrations_repeatable/trig_words.sql`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/setup/main.py` & `lute3-3.4.0/lute/db/setup/main.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/db/setup/migrator.py` & `lute3-3.4.0/lute/db/setup/migrator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/dev_api/routes.py` & `lute3-3.4.0/lute/dev_api/routes.py`
...
### Comparing `lute3-3.3.3b1/lute/language/forms.py` & `lute3-3.4.0/lute/language/forms.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/language/routes.py` & `lute3-3.4.0/lute/language/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/language/service.py` & `lute3-3.4.0/lute/language/service.py`
...
### Comparing `lute3-3.3.3b1/lute/main.py` & `lute3-3.4.0/lute/main.py`
...
### Comparing `lute3-3.3.3b1/lute/models/book.py` & `lute3-3.4.0/lute/models/book.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/models/language.py` & `lute3-3.4.0/lute/models/language.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/models/setting.py` & `lute3-3.4.0/lute/models/setting.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/models/term.py` & `lute3-3.4.0/lute/models/term.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/parse/base.py` & `lute3-3.4.0/lute/parse/base.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/parse/character_parser.py` & `lute3-3.4.0/lute/parse/character_parser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/parse/mecab_parser.py` & `lute3-3.4.0/lute/parse/mecab_parser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/parse/registry.py` & `lute3-3.4.0/lute/parse/registry.py`
...
### Comparing `lute3-3.3.3b1/lute/parse/space_delimited_parser.py` & `lute3-3.4.0/lute/parse/space_delimited_parser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/read/render/renderable_calculator.py` & `lute3-3.4.0/lute/read/render/renderable_calculator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/read/render/service.py` & `lute3-3.4.0/lute/read/render/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/read/routes.py` & `lute3-3.4.0/lute/read/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/read/service.py` & `lute3-3.4.0/lute/read/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/settings/routes.py` & `lute3-3.4.0/lute/settings/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/animated-overlay.gif` & `lute3-3.4.0/lute/static/css/images/animated-overlay.gif`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/jplayer-black-and-yellow.png` & `lute3-3.4.0/lute/static/css/images/jplayer-black-and-yellow.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/jplayer.blue.monday.jpg` & `lute3-3.4.0/lute/static/css/images/jplayer.blue.monday.jpg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/pbar-ani.gif` & `lute3-3.4.0/lute/static/css/images/pbar-ani.gif`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_222222_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_222222_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_2e83ff_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_2e83ff_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_444444_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_444444_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_454545_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_454545_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_555555_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_555555_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_777620_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_777620_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_777777_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_777777_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_888888_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_888888_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_BBBBBB_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_BBBBBB_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_cc0000_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_cc0000_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_cd0a0a_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_cd0a0a_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/images/ui-icons_ffffff_256x240.png` & `lute3-3.4.0/lute/static/css/images/ui-icons_ffffff_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/player-styles.css` & `lute3-3.4.0/lute/static/css/player-styles.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/css/styles.css` & `lute3-3.4.0/lute/static/css/styles.css`
...
### Comparing `lute3-3.3.3b1/lute/static/favicon.ico` & `lute3-3.4.0/lute/static/favicon.ico`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/favicon_dev.ico` & `lute3-3.4.0/lute/static/favicon_dev.ico`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/arrow-circle-135.png` & `lute3-3.4.0/lute/static/icn/arrow-circle-135.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/arrow-circle-225-left.png` & `lute3-3.4.0/lute/static/icn/arrow-circle-225-left.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/arrow-circle-315.png` & `lute3-3.4.0/lute/static/icn/arrow-circle-315.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/arrow-repeat.png` & `lute3-3.4.0/lute/static/icn/arrow-repeat.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/arrow-stop.png` & `lute3-3.4.0/lute/static/icn/arrow-stop.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/book--pencil.png` & `lute3-3.4.0/lute/static/icn/book--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/book-open-bookmark.png` & `lute3-3.4.0/lute/static/icn/book-open-bookmark.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/book-open-text.png` & `lute3-3.4.0/lute/static/icn/book-open-text.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/book-open-text.svg` & `lute3-3.4.0/lute/static/icn/book-open-text.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/bookmark-off.svg` & `lute3-3.4.0/lute/static/icn/bookmark-off.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/broom.png` & `lute3-3.4.0/lute/static/icn/broom.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/card--pencil.png` & `lute3-3.4.0/lute/static/icn/card--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/clock.png` & `lute3-3.4.0/lute/static/icn/clock.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/close-white.svg` & `lute3-3.4.0/lute/static/icn/close-white.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/close.svg` & `lute3-3.4.0/lute/static/icn/close.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/control-stop.png` & `lute3-3.4.0/lute/static/icn/control-stop.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/cross-big.png` & `lute3-3.4.0/lute/static/icn/cross-big.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/cross-button.png` & `lute3-3.4.0/lute/static/icn/cross-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/cross.png` & `lute3-3.4.0/lute/static/icn/cross.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/document--pencil.png` & `lute3-3.4.0/lute/static/icn/document--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/drag-handle.svg` & `lute3-3.4.0/lute/static/icn/drag-handle.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/drawer--minus.png` & `lute3-3.4.0/lute/static/icn/drawer--minus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/drawer--plus.png` & `lute3-3.4.0/lute/static/icn/drawer--plus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/eraser.png` & `lute3-3.4.0/lute/static/icn/eraser.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/exclamation-button.png` & `lute3-3.4.0/lute/static/icn/exclamation-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/exclamation-red.png` & `lute3-3.4.0/lute/static/icn/exclamation-red.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/external.png` & `lute3-3.4.0/lute/static/icn/external.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/eye.png` & `lute3-3.4.0/lute/static/icn/eye.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/feed--pencil.png` & `lute3-3.4.0/lute/static/icn/feed--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/feed--plus.png` & `lute3-3.4.0/lute/static/icn/feed--plus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/ff.svg` & `lute3-3.4.0/lute/static/icn/ff.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/font-decrease.svg` & `lute3-3.4.0/lute/static/icn/font-decrease.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/font-increase.svg` & `lute3-3.4.0/lute/static/icn/font-increase.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/funnel--minus.png` & `lute3-3.4.0/lute/static/icn/funnel--minus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/funnel.png` & `lute3-3.4.0/lute/static/icn/funnel.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/images.svg` & `lute3-3.4.0/lute/static/icn/images.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/inbox-download.png` & `lute3-3.4.0/lute/static/icn/inbox-download.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/inbox-upload.png` & `lute3-3.4.0/lute/static/icn/inbox-upload.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/indicator.gif` & `lute3-3.4.0/lute/static/icn/indicator.gif`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb-A.png` & `lute3-3.4.0/lute/static/icn/light-bulb-A.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb-T.png` & `lute3-3.4.0/lute/static/icn/light-bulb-T.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb-off-A.png` & `lute3-3.4.0/lute/static/icn/light-bulb-off-A.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb-off-T.png` & `lute3-3.4.0/lute/static/icn/light-bulb-off-T.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb-off.png` & `lute3-3.4.0/lute/static/icn/light-bulb-off.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/light-bulb.png` & `lute3-3.4.0/lute/static/icn/light-bulb.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/lightning.png` & `lute3-3.4.0/lute/static/icn/lightning.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/line-spacing-decrease.svg` & `lute3-3.4.0/lute/static/icn/line-spacing-decrease.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/line-spacing-increase.svg` & `lute3-3.4.0/lute/static/icn/line-spacing-increase.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/navigation-000-button.png` & `lute3-3.4.0/lute/static/icn/navigation-000-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/navigation-180-button.png` & `lute3-3.4.0/lute/static/icn/navigation-180-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/new_line.png` & `lute3-3.4.0/lute/static/icn/new_line.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/notebook--minus.png` & `lute3-3.4.0/lute/static/icn/notebook--minus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/notebook--pencil.png` & `lute3-3.4.0/lute/static/icn/notebook--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/notebook--plus.png` & `lute3-3.4.0/lute/static/icn/notebook--plus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/notebook.png` & `lute3-3.4.0/lute/static/icn/notebook.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/open.svg` & `lute3-3.4.0/lute/static/icn/open.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/photo-album.png` & `lute3-3.4.0/lute/static/icn/photo-album.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/pin.svg` & `lute3-3.4.0/lute/static/icn/pin.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/plus-button.png` & `lute3-3.4.0/lute/static/icn/plus-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/plus.png` & `lute3-3.4.0/lute/static/icn/plus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/printer.png` & `lute3-3.4.0/lute/static/icn/printer.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/question-balloon.png` & `lute3-3.4.0/lute/static/icn/question-balloon.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/question-frame.png` & `lute3-3.4.0/lute/static/icn/question-frame.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/reload.png` & `lute3-3.4.0/lute/static/icn/reload.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/rewind.svg` & `lute3-3.4.0/lute/static/icn/rewind.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/script-import.png` & `lute3-3.4.0/lute/static/icn/script-import.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/settings-gear-icon.svg` & `lute3-3.4.0/lute/static/icn/settings-gear-icon.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/skip-back.svg` & `lute3-3.4.0/lute/static/icn/skip-back.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/smiley-sad.png` & `lute3-3.4.0/lute/static/icn/smiley-sad.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/smiley.png` & `lute3-3.4.0/lute/static/icn/smiley.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/speaker-volume.png` & `lute3-3.4.0/lute/static/icn/speaker-volume.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/star.png` & `lute3-3.4.0/lute/static/icn/star.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-note--pencil.png` & `lute3-3.4.0/lute/static/icn/sticky-note--pencil.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-note--plus.png` & `lute3-3.4.0/lute/static/icn/sticky-note--plus.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-note-text.png` & `lute3-3.4.0/lute/static/icn/sticky-note-text.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-notes-stack.png` & `lute3-3.4.0/lute/static/icn/sticky-notes-stack.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-notes-text.png` & `lute3-3.4.0/lute/static/icn/sticky-notes-text.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/sticky-notes.png` & `lute3-3.4.0/lute/static/icn/sticky-notes.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/test_correct.png` & `lute3-3.4.0/lute/static/icn/test_correct.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/test_notyet.png` & `lute3-3.4.0/lute/static/icn/test_notyet.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/test_wrong.png` & `lute3-3.4.0/lute/static/icn/test_wrong.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/text-column-one.svg` & `lute3-3.4.0/lute/static/icn/text-column-one.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/text-column-two.svg` & `lute3-3.4.0/lute/static/icn/text-column-two.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/thumb-up.png` & `lute3-3.4.0/lute/static/icn/thumb-up.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/thumb.png` & `lute3-3.4.0/lute/static/icn/thumb.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/tick-button-small.png` & `lute3-3.4.0/lute/static/icn/tick-button-small.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/tick-button.png` & `lute3-3.4.0/lute/static/icn/tick-button.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/tick.png` & `lute3-3.4.0/lute/static/icn/tick.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/volume.svg` & `lute3-3.4.0/lute/static/icn/volume.svg`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/waiting.gif` & `lute3-3.4.0/lute/static/icn/waiting.gif`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/waiting2.gif` & `lute3-3.4.0/lute/static/icn/waiting2.gif`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/wizard.png` & `lute3-3.4.0/lute/static/icn/wizard.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/icn/wrench-screwdriver.png` & `lute3-3.4.0/lute/static/icn/wrench-screwdriver.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/apple-touch-icon-114x114.png` & `lute3-3.4.0/lute/static/img/apple-touch-icon-114x114.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/apple-touch-icon-57x57.png` & `lute3-3.4.0/lute/static/img/apple-touch-icon-57x57.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/apple-touch-icon-72x72.png` & `lute3-3.4.0/lute/static/img/apple-touch-icon-72x72.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/apple-touch-startup.png` & `lute3-3.4.0/lute/static/img/apple-touch-startup.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/lute.png` & `lute3-3.4.0/lute/static/img/lute.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/public_domain.png` & `lute3-3.4.0/lute/static/img/public_domain.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_444444_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_444444_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_555555_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_555555_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_777620_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_777620_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_777777_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_777777_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_cc0000_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_cc0000_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/img/ui-icons_ffffff_256x240.png` & `lute3-3.4.0/lute/static/img/ui-icons_ffffff_256x240.png`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/js/dict-tabs.js` & `lute3-3.4.0/lute/static/js/dict-tabs.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/js/lute.js` & `lute3-3.4.0/lute/static/js/lute.js`
...
### Comparing `lute3-3.3.3b1/lute/static/js/player.js` & `lute3-3.4.0/lute/static/js/player.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/js/resize.js` & `lute3-3.4.0/lute/static/js/resize.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/js/text-options.js` & `lute3-3.4.0/lute/static/js/text-options.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/chartjs/chart.umd.js` & `lute3-3.4.0/lute/static/vendor/chartjs/chart.umd.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/chartjs/chartjs-adapter-date-fns.js` & `lute3-3.4.0/lute/static/vendor/chartjs/chartjs-adapter-date-fns.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/datatables/README.md` & `lute3-3.4.0/lute/static/vendor/datatables/README.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/datatables/datatables.button.download.js` & `lute3-3.4.0/lute/static/vendor/datatables/datatables.button.download.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/datatables/datatables.min.css` & `lute3-3.4.0/lute/static/vendor/datatables/datatables.min.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/datatables/datatables.min.js` & `lute3-3.4.0/lute/static/vendor/datatables/datatables.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jplayer.css` & `lute3-3.4.0/lute/static/vendor/jquery/jplayer.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery-ui.css` & `lute3-3.4.0/lute/static/vendor/jquery/jquery-ui.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery-ui.min.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery-ui.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.hoverIntent.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.hoverIntent.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.jeditable.mini.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.jeditable.mini.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.jplayer.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.jplayer.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.jplayer.min.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.jplayer.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.jplayer.swf` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.jplayer.swf`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.scrollTo.min.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.scrollTo.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/jquery/jquery.xpath.min.js` & `lute3-3.4.0/lute/static/vendor/jquery/jquery.xpath.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/tagify/tagify.css` & `lute3-3.4.0/lute/static/vendor/tagify/tagify.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/tagify/tagify.min.js` & `lute3-3.4.0/lute/static/vendor/tagify/tagify.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/tagify/tagify.polyfills.min.js` & `lute3-3.4.0/lute/static/vendor/tagify/tagify.polyfills.min.js`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/static/vendor/tagify/tagify_overrides.css` & `lute3-3.4.0/lute/static/vendor/tagify/tagify_overrides.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/stats/service.py` & `lute3-3.4.0/lute/stats/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/backup/backup.html` & `lute3-3.4.0/lute/templates/backup/backup.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/backup/index.html` & `lute3-3.4.0/lute/templates/backup/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/base.html` & `lute3-3.4.0/lute/templates/base.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/book/create_new.html` & `lute3-3.4.0/lute/templates/book/create_new.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/book/edit.html` & `lute3-3.4.0/lute/templates/book/edit.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/book/import_webpage.html` & `lute3-3.4.0/lute/templates/book/import_webpage.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/book/tablelisting.html` & `lute3-3.4.0/lute/templates/book/tablelisting.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/errors/404_error.html` & `lute3-3.4.0/lute/templates/errors/404_error.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/errors/500_error.html` & `lute3-3.4.0/lute/templates/errors/500_error.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/hotkeys.html` & `lute3-3.4.0/lute/templates/hotkeys.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/imagesearch/index.html` & `lute3-3.4.0/lute/templates/imagesearch/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/index.html` & `lute3-3.4.0/lute/templates/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/language/_form.html` & `lute3-3.4.0/lute/templates/language/_form.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/language/index.html` & `lute3-3.4.0/lute/templates/language/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/language/list_predefined.html` & `lute3-3.4.0/lute/templates/language/list_predefined.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/language/new.html` & `lute3-3.4.0/lute/templates/language/new.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/audio_player.html` & `lute3-3.4.0/lute/templates/read/audio_player.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/flashcopied.html` & `lute3-3.4.0/lute/templates/read/flashcopied.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/frameform.html` & `lute3-3.4.0/lute/templates/read/frameform.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/index.html` & `lute3-3.4.0/lute/templates/read/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/page_content.html` & `lute3-3.4.0/lute/templates/read/page_content.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/page_edit_form.html` & `lute3-3.4.0/lute/templates/read/page_edit_form.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/reading_menu.html` & `lute3-3.4.0/lute/templates/read/reading_menu.html`
...
### Comparing `lute3-3.3.3b1/lute/templates/read/termpopup.html` & `lute3-3.4.0/lute/templates/read/termpopup.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/read/updated.html` & `lute3-3.4.0/lute/templates/read/updated.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/settings/form.html` & `lute3-3.4.0/lute/templates/settings/form.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/stats/index.html` & `lute3-3.4.0/lute/templates/stats/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/term/_form.html` & `lute3-3.4.0/lute/templates/term/_form.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/term/formframes.html` & `lute3-3.4.0/lute/templates/term/formframes.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/term/index.html` & `lute3-3.4.0/lute/templates/term/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/term/sentences.html` & `lute3-3.4.0/lute/templates/term/sentences.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/termimport/index.html` & `lute3-3.4.0/lute/templates/termimport/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/termtag/_form.html` & `lute3-3.4.0/lute/templates/termtag/_form.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/termtag/index.html` & `lute3-3.4.0/lute/templates/termtag/index.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/templates/version.html` & `lute3-3.4.0/lute/templates/version.html`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term/datatables.py` & `lute3-3.4.0/lute/term/datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term/forms.py` & `lute3-3.4.0/lute/term/forms.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term/model.py` & `lute3-3.4.0/lute/term/model.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term/routes.py` & `lute3-3.4.0/lute/term/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term_parent_map/routes.py` & `lute3-3.4.0/lute/term_parent_map/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/term_parent_map/service.py` & `lute3-3.4.0/lute/term_parent_map/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/termimport/routes.py` & `lute3-3.4.0/lute/termimport/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/termimport/service.py` & `lute3-3.4.0/lute/termimport/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/termtag/datatables.py` & `lute3-3.4.0/lute/termtag/datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/termtag/routes.py` & `lute3-3.4.0/lute/termtag/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/css/Apple_Books.css` & `lute3-3.4.0/lute/themes/css/Apple_Books.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/css/Dark_slate.css` & `lute3-3.4.0/lute/themes/css/Dark_slate.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/css/LWT.css` & `lute3-3.4.0/lute/themes/css/LWT.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/css/LingQ.css` & `lute3-3.4.0/lute/themes/css/LingQ.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/css/Night.css` & `lute3-3.4.0/lute/themes/css/Night.css`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/routes.py` & `lute3-3.4.0/lute/themes/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/themes/service.py` & `lute3-3.4.0/lute/themes/service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/useraudio/routes.py` & `lute3-3.4.0/lute/useraudio/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/userimage/routes.py` & `lute3-3.4.0/lute/userimage/routes.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/utils/data_tables.py` & `lute3-3.4.0/lute/utils/data_tables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/utils/debug_helpers.py` & `lute3-3.4.0/lute/utils/debug_helpers.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/lute/utils/formutils.py` & `lute3-3.4.0/lute/utils/formutils.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/pyproject.toml` & `lute3-3.4.0/pyproject.toml`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/requirements.txt` & `lute3-3.4.0/requirements.txt`
...
### Comparing `lute3-3.3.3b1/scripts/dump_lang_data.py` & `lute3-3.4.0/scripts/dump_lang_data.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tasks.py` & `lute3-3.4.0/tasks.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/book.feature` & `lute3-3.4.0/tests/acceptance/book.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/conftest.py` & `lute3-3.4.0/tests/acceptance/conftest.py`
...
### Comparing `lute3-3.3.3b1/tests/acceptance/lute_test_client.py` & `lute3-3.4.0/tests/acceptance/lute_test_client.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/reading.feature` & `lute3-3.4.0/tests/acceptance/reading.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/sample_files/Hola.epub` & `lute3-3.4.0/tests/acceptance/sample_files/Hola.epub`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/sample_files/Hola.pdf` & `lute3-3.4.0/tests/acceptance/sample_files/Hola.pdf`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/sample_files/invalid_empty.epub` & `lute3-3.4.0/tests/acceptance/sample_files/invalid_empty.epub`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/smoke.feature` & `lute3-3.4.0/tests/acceptance/smoke.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/start_acceptance_app.py` & `lute3-3.4.0/tests/acceptance/start_acceptance_app.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/sync_status.feature` & `lute3-3.4.0/tests/acceptance/sync_status.feature`
...
### Comparing `lute3-3.3.3b1/tests/acceptance/term.feature` & `lute3-3.4.0/tests/acceptance/term.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/acceptance/unsupported_parser.feature` & `lute3-3.4.0/tests/acceptance/unsupported_parser.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/conftest.py` & `lute3-3.4.0/tests/conftest.py`
...
### Comparing `lute3-3.3.3b1/tests/dbasserts.py` & `lute3-3.4.0/tests/dbasserts.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/README.md` & `lute3-3.4.0/tests/features/README.md`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/rendering.feature` & `lute3-3.4.0/tests/features/rendering.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/term_import.feature` & `lute3-3.4.0/tests/features/term_import.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/term_import_status_0.feature` & `lute3-3.4.0/tests/features/term_import_status_0.feature`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/test_rendering.py` & `lute3-3.4.0/tests/features/test_rendering.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/features/test_term_import.py` & `lute3-3.4.0/tests/features/test_term_import.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/integration/test_main.py` & `lute3-3.4.0/tests/integration/test_main.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/orm/test_Book.py` & `lute3-3.4.0/tests/orm/test_Book.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/orm/test_Language.py` & `lute3-3.4.0/tests/orm/test_Language.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/orm/test_Term.py` & `lute3-3.4.0/tests/orm/test_Term.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/orm/test_Text.py` & `lute3-3.4.0/tests/orm/test_Text.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/playwright/playwright.py` & `lute3-3.4.0/tests/playwright/playwright.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/backup/test_backup.py` & `lute3-3.4.0/tests/unit/backup/test_backup.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/book/test_Repository.py` & `lute3-3.4.0/tests/unit/book/test_Repository.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/book/test_datatables.py` & `lute3-3.4.0/tests/unit/book/test_datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/book/test_stats.py` & `lute3-3.4.0/tests/unit/book/test_stats.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/cli/test_language_term_export.py` & `lute3-3.4.0/tests/unit/cli/test_language_term_export.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/config/test_app_config.py` & `lute3-3.4.0/tests/unit/config/test_app_config.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/db/setup/test_BackupManager.py` & `lute3-3.4.0/tests/unit/db/setup/test_BackupManager.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/db/setup/test_Setup.py` & `lute3-3.4.0/tests/unit/db/setup/test_Setup.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/db/setup/test_SqliteMigrator.py` & `lute3-3.4.0/tests/unit/db/setup/test_SqliteMigrator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/db/test_demo.py` & `lute3-3.4.0/tests/unit/db/test_demo.py`
...
### Comparing `lute3-3.3.3b1/tests/unit/db/test_management.py` & `lute3-3.4.0/tests/unit/db/test_management.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/language/test_service.py` & `lute3-3.4.0/tests/unit/language/test_service.py`
...
### Comparing `lute3-3.3.3b1/tests/unit/models/test_Book.py` & `lute3-3.4.0/tests/unit/models/test_Book.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_Book_add_remove_pages.py` & `lute3-3.4.0/tests/unit/models/test_Book_add_remove_pages.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_Language.py` & `lute3-3.4.0/tests/unit/models/test_Language.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_Setting.py` & `lute3-3.4.0/tests/unit/models/test_Setting.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_Term.py` & `lute3-3.4.0/tests/unit/models/test_Term.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_TermTag.py` & `lute3-3.4.0/tests/unit/models/test_TermTag.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/models/test_Text.py` & `lute3-3.4.0/tests/unit/models/test_Text.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/parse/test_ClassicalChineseParser.py` & `lute3-3.4.0/tests/unit/parse/test_ClassicalChineseParser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/parse/test_JapaneseParser.py` & `lute3-3.4.0/tests/unit/parse/test_JapaneseParser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/parse/test_SentenceGroupIterator.py` & `lute3-3.4.0/tests/unit/parse/test_SentenceGroupIterator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/parse/test_SpaceDelimitedParser.py` & `lute3-3.4.0/tests/unit/parse/test_SpaceDelimitedParser.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/parse/test_registry.py` & `lute3-3.4.0/tests/unit/parse/test_registry.py`
...
### Comparing `lute3-3.3.3b1/tests/unit/read/render/test_RenderableCalculator.py` & `lute3-3.4.0/tests/unit/read/render/test_RenderableCalculator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/read/render/test_TokenLocator.py` & `lute3-3.4.0/tests/unit/read/render/test_TokenLocator.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/read/test_service.py` & `lute3-3.4.0/tests/unit/read/test_service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/read/test_service_popup_data.py` & `lute3-3.4.0/tests/unit/read/test_service_popup_data.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/stats/test_service.py` & `lute3-3.4.0/tests/unit/stats/test_service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/term/test_Repository.py` & `lute3-3.4.0/tests/unit/term/test_Repository.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/term/test_TermForm.py` & `lute3-3.4.0/tests/unit/term/test_TermForm.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/term/test_Term_status_follow.py` & `lute3-3.4.0/tests/unit/term/test_Term_status_follow.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/term/test_datatables.py` & `lute3-3.4.0/tests/unit/term/test_datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/term_parent_map/test_service.py` & `lute3-3.4.0/tests/unit/term_parent_map/test_service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/termtag/test_datatables.py` & `lute3-3.4.0/tests/unit/termtag/test_datatables.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/themes/test_service.py` & `lute3-3.4.0/tests/unit/themes/test_service.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/utils/test_DataTablesSqliteQuery.py` & `lute3-3.4.0/tests/unit/utils/test_DataTablesSqliteQuery.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/unit/utils/test_formutils.py` & `lute3-3.4.0/tests/unit/utils/test_formutils.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/tests/utils.py` & `lute3-3.4.0/tests/utils.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/utils/dump_changelog.sh` & `lute3-3.4.0/utils/dump_changelog.sh`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/utils/findstring.sh` & `lute3-3.4.0/utils/findstring.sh`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/utils/todos.py` & `lute3-3.4.0/utils/todos.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/utils/verify.py` & `lute3-3.4.0/utils/verify.py`

 * *Files identical despite different names*

### Comparing `lute3-3.3.3b1/PKG-INFO` & `lute3-3.4.0/PKG-INFO`
